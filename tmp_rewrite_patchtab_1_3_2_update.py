...
new_text = (
    ...
    ' - 게시글 삭제-only와 도배 방지 샘플/신규 글 삭제가 정상 동작하도록 삭제 AJAX 경로를 보정했습니다.\n'
    '* 게시글 삭제 토큰 처리 보강\n'
    ' - 게시글 삭제 요청의 ci_t를 cookie의 ci_c가 아니라 상세 페이지에서 읽은 실제 ci_t로 보내도록 수정했습니다.\n'
    '* 삭제 진단 로그 추가\n'
    ' - 디버그 모드에서 gallType, gallId, 글번호, 실제 deleteUrl을 확인할 수 있도록 했습니다.\n\n'
    'v1.3.1 (2026-04-21)\n'
    '* 도배 방지 기능 추가\n'
